/** Shared class names. Keep this file free of "use client" so server pages can use it. */
...
export const btnDanger =
  "inline-flex min-h-11 w-full items-center justify-center rounded-sm border border-danger/40 bg-transparent px-3 py-2.5 text-center text-[13px] font-medium leading-tight text-danger hover:bg-danger-soft disabled:opacity-55 sm:w-auto sm:shrink-0 sm:whitespace-nowrap sm:px-4";
...
export const fieldArea =
  "mt-1 w-full rounded-sm border border-line bg-cream px-3 py-2 text-sm text-ink placeholder:text-muted/70";
